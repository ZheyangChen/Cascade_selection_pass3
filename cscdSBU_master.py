...
from book_newnames import change_names 
...
parser.add_argument("-v", "--filterver",
                    default="old",
                    dest="FILTER_VER",
                    help="whether or not to run with new filter.")
...
if filter_ver == 'new':
    tray.AddModule(change_names,version = filter_ver)
